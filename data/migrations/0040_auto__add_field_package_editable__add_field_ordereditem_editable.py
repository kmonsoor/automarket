...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.editable'
        db.add_column('data_package', 'editable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'OrderedItem.editable'
        db.add_column('data_ordereditem', 'editable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.editable'
        db.delete_column('data_package', 'editable')

        # Deleting field 'OrderedItem.editable'
        db.delete_column('data_ordereditem', 'editable')
