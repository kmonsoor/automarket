...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.client_manager'
        db.add_column('data_userprofile', 'client_manager',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='client_manager', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.client_manager'
        db.delete_column('data_userprofile', 'client_manager_id')
