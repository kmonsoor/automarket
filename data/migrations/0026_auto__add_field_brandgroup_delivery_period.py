...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrandGroup.delivery_period'
        db.add_column('data_brandgroup', 'delivery_period',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrandGroup.delivery_period'
        db.delete_column('data_brandgroup', 'delivery_period')
