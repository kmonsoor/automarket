...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Package.brandgroup'
        db.delete_column('data_package', 'brandgroup_id')

        # Adding field 'Invoice.brandgroup'
        db.add_column('data_invoice', 'brandgroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.BrandGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Package.brandgroup'
        db.add_column('data_package', 'brandgroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['data.BrandGroup']),
                      keep_default=False)

        # Deleting field 'Invoice.brandgroup'
        db.delete_column('data_invoice', 'brandgroup_id')
