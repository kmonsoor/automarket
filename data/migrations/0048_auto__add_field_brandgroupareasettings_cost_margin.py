...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrandGroupAreaSettings.cost_margin'
        db.add_column('data_brandgroupareasettings', 'cost_margin',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrandGroupAreaSettings.cost_margin'
        db.delete_column('data_brandgroupareasettings', 'cost_margin')
