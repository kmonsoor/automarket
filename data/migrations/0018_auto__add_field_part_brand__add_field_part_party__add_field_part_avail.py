...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Part.brand'
        db.add_column('data_part', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Brand'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Part.party'
        db.add_column('data_part', 'party',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Part.available'
        db.add_column('data_part', 'available',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Part.delivery_period'
        db.add_column('data_part', 'delivery_period',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Part.date_update'
        db.add_column('data_part', 'date_update',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Part.brand'
        db.delete_column('data_part', 'brand_id')

        # Deleting field 'Part.party'
        db.delete_column('data_part', 'party')

        # Deleting field 'Part.available'
        db.delete_column('data_part', 'available')

        # Deleting field 'Part.delivery_period'
        db.delete_column('data_part', 'delivery_period')

        # Deleting field 'Part.date_update'
        db.delete_column('data_part', 'date_update')
