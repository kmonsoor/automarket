...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.client_group'
        db.alter_column('data_userprofile', 'client_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.ClientGroup'], null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.client_group'
        db.alter_column('data_userprofile', 'client_group_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['data.ClientGroup']))
