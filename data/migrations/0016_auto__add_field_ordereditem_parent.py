...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderedItem.parent'
        db.add_column('data_ordereditem', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.OrderedItem'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderedItem.parent'
        db.delete_column('data_ordereditem', 'parent_id')
