...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'data.areadeliveryperiod': {
            'Meta': {'unique_together': "(('area', 'brandgroup'),)", 'object_name': 'AreaDeliveryPeriod'},
            ...
            'delivery_period': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'data.basket': {
        ...
        'data.part': {
            ...
            'cost': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_update': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'data.pricearea': {
            'Meta': {'unique_together': "(('area', 'brandgroup'),)", 'object_name': 'PriceArea'},
            'area': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['data.Area']"}),
            'brandgroup': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['data.BrandGroup']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.files.FileField', [], {'max_length': '100'})
        },
        'data.userprofile': {
