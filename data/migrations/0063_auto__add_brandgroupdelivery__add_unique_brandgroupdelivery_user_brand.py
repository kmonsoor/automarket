...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BrandGroupDelivery'
        db.create_table('data_brandgroupdelivery', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('brand_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.BrandGroup'])),
            ('delivery_coef', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('data', ['BrandGroupDelivery'])

        # Adding unique constraint on 'BrandGroupDelivery', fields ['user', 'brand_group']
        db.create_unique('data_brandgroupdelivery', ['user_id', 'brand_group_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'BrandGroupDelivery', fields ['user', 'brand_group']
        db.delete_unique('data_brandgroupdelivery', ['user_id', 'brand_group_id'])

        # Deleting model 'BrandGroupDelivery'
        db.delete_table('data_brandgroupdelivery')
    ...
    models = {
        ...
        'data.brandgroupdelivery': {
            'Meta': {'unique_together': "(('user', 'brand_group'),)", 'object_name': 'BrandGroupDelivery'},
            'brand_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['data.BrandGroup']"}),
