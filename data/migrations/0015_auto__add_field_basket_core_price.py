...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Basket.core_price'
        db.add_column('data_basket', 'core_price', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Basket.core_price'
        db.delete_column('data_basket', 'core_price')
