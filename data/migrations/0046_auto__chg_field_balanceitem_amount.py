...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BalanceItem.amount'
        db.alter_column('data_balanceitem', 'amount', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'BalanceItem.amount'
        db.alter_column('data_balanceitem', 'amount', self.gf('django.db.models.fields.FloatField')(default=0))
