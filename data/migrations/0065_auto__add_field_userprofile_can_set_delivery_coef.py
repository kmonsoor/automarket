...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.can_set_delivery_coef'
        db.add_column('data_userprofile', 'can_set_delivery_coef',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.can_set_delivery_coef'
        db.delete_column('data_userprofile', 'can_set_delivery_coef')
