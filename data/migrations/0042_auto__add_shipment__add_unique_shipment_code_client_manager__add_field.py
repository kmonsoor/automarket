...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('data_shipment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'shipment_client', to=orm['auth.User'])),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'shipment_manager', to=orm['auth.User'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'user', to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('data', ['Shipment'])

        # Adding unique constraint on 'Shipment', fields ['code', 'client', 'manager']
        db.create_unique('data_shipment', ['code', 'client_id', 'manager_id'])

        # Adding field 'Package.shipment'
        db.add_column('data_package', 'shipment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Shipment'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrderedItem.shipment'
        db.add_column('data_ordereditem', 'shipment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Shipment'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'Shipment', fields ['code', 'client', 'manager']
        db.delete_unique('data_shipment', ['code', 'client_id', 'manager_id'])

        # Deleting model 'Shipment'
        db.delete_table('data_shipment')

        # Deleting field 'Package.shipment'
        db.delete_column('data_package', 'shipment_id')

        # Deleting field 'OrderedItem.shipment'
        db.delete_column('data_ordereditem', 'shipment_id')
    ...
    models = {
        ...
        'data.shipment': {
            'Meta': {'unique_together': "(('code', 'client', 'manager'),)", 'object_name': 'Shipment'},
