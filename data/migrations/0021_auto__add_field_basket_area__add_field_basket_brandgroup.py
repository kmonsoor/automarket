...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Basket.area'
        db.add_column('data_basket', 'area',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Basket.brandgroup'
        db.add_column('data_basket', 'brandgroup',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Basket.area'
        db.delete_column('data_basket', 'area')

        # Deleting field 'Basket.brandgroup'
        db.delete_column('data_basket', 'brandgroup')
