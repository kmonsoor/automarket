...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('data_package', (
            ...
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Invoice'])),
            ('weight', self.gf('django.db.models.fields.FloatField')()),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'manager_package', to=orm['auth.User'])),
            ...
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'client_package', null=True, to=orm['auth.User'])),
        ))
