...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Part.brandgroup'
        db.add_column('data_part', 'brandgroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.BrandGroup'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Part.brandgroup'
        db.delete_column('data_part', 'brandgroup_id')
