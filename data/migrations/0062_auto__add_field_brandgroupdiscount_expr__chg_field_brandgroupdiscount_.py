...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrandGroupDiscount.expr'
        db.add_column('data_brandgroupdiscount', 'expr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'BrandGroupDiscount.discount'
        db.alter_column('data_brandgroupdiscount', 'discount', self.gf('django.db.models.fields.FloatField')(null=True))
        # Adding field 'Discount.expr'
        db.add_column('data_discount', 'expr',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Discount.discount'
        db.alter_column('data_discount', 'discount', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Deleting field 'BrandGroupDiscount.expr'
        db.delete_column('data_brandgroupdiscount', 'expr')


        # Changing field 'BrandGroupDiscount.discount'
        db.alter_column('data_brandgroupdiscount', 'discount', self.gf('django.db.models.fields.FloatField')(default=None))
        # Deleting field 'Discount.expr'
        db.delete_column('data_discount', 'expr')


        # Changing field 'Discount.discount'
        db.alter_column('data_discount', 'discount', self.gf('django.db.models.fields.FloatField')(default=None))
    ...
    models = {
        ...
        'data.brandgroupdiscount': {
            ...
            'expr': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
