...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'AreaDeliveryPeriod', fields ['area', 'brandgroup']
        db.delete_unique('data_areadeliveryperiod', ['area_id', 'brandgroup_id'])

        # Removing unique constraint on 'PriceArea', fields ['area', 'brandgroup']
        db.delete_unique('data_pricearea', ['area_id', 'brandgroup_id'])

        # Deleting model 'PriceArea'
        db.delete_table('data_pricearea')

        # Deleting model 'AreaDeliveryPeriod'
        db.delete_table('data_areadeliveryperiod')

        # Adding field 'BrandGroupAreaSettings.price'
        db.add_column('data_brandgroupareasettings', 'price',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'BrandGroupAreaSettings.price_updated_at'
        db.add_column('data_brandgroupareasettings', 'price_updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'PriceArea'
        db.create_table('data_pricearea', (
            ('price', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ...
        db.send_create_signal('data', ['PriceArea'])

        # Adding unique constraint on 'PriceArea', fields ['area', 'brandgroup']
        db.create_unique('data_pricearea', ['area_id', 'brandgroup_id'])

        # Adding model 'AreaDeliveryPeriod'
        db.create_table('data_areadeliveryperiod', (
            ('delivery_period', self.gf('django.db.models.fields.IntegerField')()),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('brandgroup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.BrandGroup'])),
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Area'])),
        ))
        db.send_create_signal('data', ['AreaDeliveryPeriod'])

        # Adding unique constraint on 'AreaDeliveryPeriod', fields ['area', 'brandgroup']
        db.create_unique('data_areadeliveryperiod', ['area_id', 'brandgroup_id'])

        # Deleting field 'BrandGroupAreaSettings.price'
        db.delete_column('data_brandgroupareasettings', 'price')

        # Deleting field 'BrandGroupAreaSettings.price_updated_at'
        db.delete_column('data_brandgroupareasettings', 'price_updated_at')
    ...
    models = {
        ...
        'data.ordereditem': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice_code': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
