...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Basket'
        db.create_table('data_basket', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('part_number', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('msrp', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('user_price', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('data', ['Basket'])


    def backwards(self, orm):
        
        # Deleting model 'Basket'
        db.delete_table('data_basket')
