...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Package.received_at'
        db.add_column('data_package', 'received_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Package.status'
        db.add_column('data_package', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Package.received_at'
        db.delete_column('data_package', 'received_at')

        # Deleting field 'Package.status'
        db.delete_column('data_package', 'status')
