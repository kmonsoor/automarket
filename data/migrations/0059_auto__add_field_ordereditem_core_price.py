...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderedItem.core_price'
        db.add_column('data_ordereditem', 'core_price',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderedItem.core_price'
        db.delete_column('data_ordereditem', 'core_price')
