...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderedItem.issued_at'
        db.add_column('data_ordereditem', 'issued_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderedItem.issued_at'
        db.delete_column('data_ordereditem', 'issued_at')
