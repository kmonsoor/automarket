...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Basket.brand_name'
        db.add_column('data_basket', 'brand_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'Basket.quantity'
        db.add_column('data_basket', 'quantity', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Basket.created_at'
        db.add_column('data_basket', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 10, 16, 13, 50, 25, 456438), blank=True), keep_default=False)

        # Adding field 'Basket.order_item_id'
        db.add_column('data_basket', 'order_item_id', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Basket.brand_name'
        db.delete_column('data_basket', 'brand_name')

        # Deleting field 'Basket.quantity'
        db.delete_column('data_basket', 'quantity')

        # Deleting field 'Basket.created_at'
        db.delete_column('data_basket', 'created_at')

        # Deleting field 'Basket.order_item_id'
        db.delete_column('data_basket', 'order_item_id')
