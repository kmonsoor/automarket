...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClientGroup.default'
        db.add_column('data_clientgroup', 'is_default', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):

        # Deleting field 'ClientGroup.default'
        db.delete_column('data_clientgroup', 'is_default')
