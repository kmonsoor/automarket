...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ManagerGroupDiscount.manager_group'
        db.alter_column('data_managergroupdiscount', 'manager_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.ManagerGroup']))
        ...
        # Adding field 'OrderedItem.price_manager'
        db.add_column('data_ordereditem', 'price_manager',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'OrderedItem.weight_manager'
        db.add_column('data_ordereditem', 'weight_manager',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ManagerGroupDiscount.manager_group'
        db.alter_column('data_managergroupdiscount', 'manager_group_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.ClientGroup']))
        ...
        # Deleting field 'OrderedItem.price_manager'
        db.delete_column('data_ordereditem', 'price_manager')

        # Deleting field 'OrderedItem.weight_manager'
        db.delete_column('data_ordereditem', 'weight_manager')
    ...
    models = {
        ...
        'data.ordereditem': {
            ...
            'weight_manager': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'})
        },
        'data.package': {
