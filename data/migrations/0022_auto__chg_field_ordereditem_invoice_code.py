...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderedItem.invoice_code'
        db.alter_column('data_ordereditem', 'invoice_code', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'OrderedItem.invoice_code'
        db.alter_column('data_ordereditem', 'invoice_code', self.gf('django.db.models.fields.CharField')(max_length=255))
