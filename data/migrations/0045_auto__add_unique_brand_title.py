...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Brand', fields ['title']
        db.create_unique('data_brand', ['title'])


    def backwards(self, orm):
        # Removing unique constraint on 'Brand', fields ['title']
        db.delete_unique('data_brand', ['title'])
