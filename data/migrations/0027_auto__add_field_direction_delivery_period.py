...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Direction.delivery_period'
        db.add_column('data_direction', 'delivery_period',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Direction.delivery_period'
        db.delete_column('data_direction', 'delivery_period')
