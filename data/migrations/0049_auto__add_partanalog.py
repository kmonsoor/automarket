...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PartAnalog'
        db.create_table('data_partanalog', (
            ...
            ('brand_analog', self.gf('django.db.models.fields.related.ForeignKey')(related_name='brand_analog', to=orm['data.Brand'])),
            ('partnumber_analog', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('comment1', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('comment2', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('data', ['PartAnalog'])


    def backwards(self, orm):
        # Deleting model 'PartAnalog'
        db.delete_table('data_partanalog')
