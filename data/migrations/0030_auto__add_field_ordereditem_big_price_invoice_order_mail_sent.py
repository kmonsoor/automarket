...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderedItem.big_price_invoice_order_mail_sent'
        db.add_column('data_ordereditem', 'big_price_invoice_order_mail_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderedItem.big_price_invoice_order_mail_sent'
        db.delete_column('data_ordereditem', 'big_price_invoice_order_mail_sent')
