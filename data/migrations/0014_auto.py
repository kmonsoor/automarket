...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Part', fields ['substitution']
        db.create_index('data_part', ['substitution'])

        # Adding index on 'Part', fields ['partnumber']
        db.create_index('data_part', ['partnumber'])


    def backwards(self, orm):
        
        # Removing index on 'Part', fields ['partnumber']
        db.delete_index('data_part', ['partnumber'])

        # Removing index on 'Part', fields ['substitution']
        db.delete_index('data_part', ['substitution'])
