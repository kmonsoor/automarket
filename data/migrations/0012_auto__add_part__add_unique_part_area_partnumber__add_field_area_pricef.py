...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Part'
        db.create_table('data_part', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('area', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Area'])),
            ('partnumber', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('MSRP', self.gf('django.db.models.fields.FloatField')()),
            ('cost', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('core_price', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ...
        db.send_create_signal('data', ['Part'])

        # Adding unique constraint on 'Part', fields ['area', 'partnumber']
        db.create_unique('data_part', ['area_id', 'partnumber'])

        # Adding field 'Area.pricefile'
        db.add_column('data_area', 'pricefile', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'Part', fields ['area', 'partnumber']
        db.delete_unique('data_part', ['area_id', 'partnumber'])

        # Deleting model 'Part'
        db.delete_table('data_part')
    ...
    models = {
        ...
        'data.part': {
            'MSRP': ('django.db.models.fields.FloatField', [], {}),
