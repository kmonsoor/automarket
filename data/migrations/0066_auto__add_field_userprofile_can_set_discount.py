...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.can_set_discount'
        db.add_column('data_userprofile', 'can_set_discount',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.can_set_discount'
        db.delete_column('data_userprofile', 'can_set_discount')
    ...
    models = {
        ...
        'data.brandgroupdelivery': {
            ...
            'brand_group': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['data.BrandGroup']"}),
            'delivery_coef': ('django.db.models.fields.FloatField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        ...
        'data.userprofile': {
            ...
            'can_set_delivery_coef': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'can_set_discount': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
