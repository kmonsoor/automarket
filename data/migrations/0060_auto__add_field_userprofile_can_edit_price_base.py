...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.can_edit_price_base'
        db.add_column('data_userprofile', 'can_edit_price_base',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.can_edit_price_base'
        db.delete_column('data_userprofile', 'can_edit_price_base')
