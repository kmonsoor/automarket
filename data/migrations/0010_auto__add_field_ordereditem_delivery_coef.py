...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderedItem.delivery_coef'
        db.add_column('data_ordereditem', 'delivery_coef', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'OrderedItem.delivery_coef'
        db.delete_column('data_ordereditem', 'delivery_coef')
