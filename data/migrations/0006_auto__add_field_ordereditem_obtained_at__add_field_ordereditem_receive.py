...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderedItem.obtained_at'
        db.add_column('data_ordereditem', 'obtained_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'OrderedItem.received_office_at'
        db.add_column('data_ordereditem', 'received_office_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderedItem.obtained_at'
        db.delete_column('data_ordereditem', 'obtained_at')

        # Deleting field 'OrderedItem.received_office_at'
        db.delete_column('data_ordereditem', 'received_office_at')
