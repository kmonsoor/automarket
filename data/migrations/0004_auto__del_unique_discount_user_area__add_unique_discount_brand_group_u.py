...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Discount', fields ['brand_group', 'user', 'area']
        db.create_unique('data_discount', ['brand_group_id', 'user_id', 'area_id'])

        # Adding unique constraint on 'BrandGroupDiscount', fields ['brand_group', 'user']
        db.create_unique('data_brandgroupdiscount', ['brand_group_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'BrandGroupDiscount', fields ['brand_group', 'user']
        db.delete_unique('data_brandgroupdiscount', ['brand_group_id', 'user_id'])

        # Removing unique constraint on 'Discount', fields ['brand_group', 'user', 'area']
        db.delete_unique('data_discount', ['brand_group_id', 'user_id', 'area_id'])
