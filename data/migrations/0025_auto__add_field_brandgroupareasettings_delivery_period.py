...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrandGroupAreaSettings.delivery_period'
        db.add_column('data_brandgroupareasettings', 'delivery_period',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrandGroupAreaSettings.delivery_period'
        db.delete_column('data_brandgroupareasettings', 'delivery_period')
