...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BrandGroupDelivery.delivery_coef'
        db.alter_column('data_brandgroupdelivery', 'delivery_coef', self.gf('django.db.models.fields.FloatField')(default=14))

    def backwards(self, orm):

        # Changing field 'BrandGroupDelivery.delivery_coef'
        db.alter_column('data_brandgroupdelivery', 'delivery_coef', self.gf('django.db.models.fields.FloatField')(null=True))
