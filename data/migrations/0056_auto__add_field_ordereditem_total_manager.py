...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderedItem.total_manager'
        db.add_column('data_ordereditem', 'total_manager',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderedItem.total_manager'
        db.delete_column('data_ordereditem', 'total_manager')
