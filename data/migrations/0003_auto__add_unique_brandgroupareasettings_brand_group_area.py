...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'BrandGroupAreaSettings', fields ['brand_group', 'area']
        db.create_unique('data_brandgroupareasettings', ['brand_group_id', 'area_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'BrandGroupAreaSettings', fields ['brand_group', 'area']
        db.delete_unique('data_brandgroupareasettings', ['brand_group_id', 'area_id'])
