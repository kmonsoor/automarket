...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.can_edit_weight'
        db.add_column('data_userprofile', 'can_edit_weight',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.can_edit_weight'
        db.delete_column('data_userprofile', 'can_edit_weight')
