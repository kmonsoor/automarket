...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Basket.description_ru'
        db.add_column('data_basket', 'description_ru', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Basket.comment1'
        db.add_column('data_basket', 'comment1', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Basket.description_ru'
        db.delete_column('data_basket', 'description_ru')

        # Deleting field 'Basket.comment1'
        db.delete_column('data_basket', 'comment1')
